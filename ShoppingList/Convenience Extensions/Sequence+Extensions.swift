...
extension Sequence {
		...
		// reasons," apparently involving the already defined Collections.count method,
		// but i will keep it here until/if it comes back into the language.
		// see Swift Evolution Proposal 220
