...
There are no major UI-level design changes to the app, other than a few minor moves of a button here and there, although the app now uses a standard UIActivityViewController to share a shopping list (rather than via email only).  Please check out the earlier README documents.
